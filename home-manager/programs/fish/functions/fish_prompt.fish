# curl'd on the 28th of August 2023 from https://raw.githubusercontent.com/oh-my-fish/theme-default/master/functions/fish_prompt.fish
...
## EDIT  ###############################
  ...
  set -l nix_shell_info (
      if test -n "$IN_NIX_SHELL"
          echo -s -n $nix_color " <nix-shell>" $normal_color
      end
  )
########################################
